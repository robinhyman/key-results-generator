...
- Graph-generation quality is not yet automatically evaluated. The 2026-08-17 offline characterization found that the AI prompt asks for only 8-10 nodes while the intended workflow needs a richer causal map followed by explicit convergence into a planning graph.
